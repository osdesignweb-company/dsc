    ...
    FormValidation.I18n = $.extend(true, FormValidation.I18n, {
        'es_ES': {
            ...
            date: {
                ...
                min: 'Por favor ingrese una fecha posterior al %s',
                max: 'Por favor ingrese una fecha previa al %s',
                range: 'Por favor ingrese una fecha entre el %s y el %s'
            },
            different: {
            ...
            vat: {
                'default': 'Por favor ingrese un número IVA válido',
                country: 'Por favor ingrese un número IVA válido en %s',
                countries: {
                    AT: 'Austria',
                    BE: 'Bélgica',
                    BG: 'Bulgaria',
