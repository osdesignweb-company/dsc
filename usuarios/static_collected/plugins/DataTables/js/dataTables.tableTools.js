...
TableTools.BUTTONS = {
	...
	"copy": $.extend( {}, TableTools.buttonBase, {
		...
		"fnComplete": function(nButton, oConfig, flash, text) {
			...
			this.fnInfo( '<h6>Tabla copiada</h6>'+
				'<p>Copiado '+lines+' fila'+plural+' al portapapeles.</p>',
				1500
			);
		}
	} ),
	...
	"print": $.extend( {}, TableTools.buttonBase, {
		"sInfo": "<h6>Vista de impresión</h6><p>Por favor use la función imprimir del navegador para "+
		  "imprimir esta tabla. Presione escape al terminar.</p>",
		"sMessage": null,
		"bShowAll": true,
